...
export class Groupfoodlist extends React.Component<PropListType, StateListType>
{
  keyId: string;
  ...
  render(): ReactElement
  {
    ...
    <section id="food-category-list" className="food-category-list carousel-style-1">
      <div className="container-fulid">
        <h2 className="mb-0 text-5 font-weight-bold">{l10n.localize('Classification_Of_Foods')}</h2>
        <Swiper
